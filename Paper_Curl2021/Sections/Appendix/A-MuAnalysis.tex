...
\begin{cory} \label{cory:TangCurlRotated}
	\tstk{need to check the form of this! Seems REALLY cumbersome in the way it's currently written... there's got to be a better way! Also, check the quasi-momentum formula on the edge, seems interesting...}
\end{cory}

\begin{theorem} \label{thm:TangCurlGraph}
	\tstk{adopt notation of the above once worked through.}
\end{theorem}
