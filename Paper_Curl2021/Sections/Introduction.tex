...
\end{align}
\tstk{there shouldn't be a $-$ sign on the LHS?!?!?!?}
...
\end{align}
where $\ktgrad_{\dddmes}$ acts component-wise (in the same way as the familiar curl operation). % = \bracs{\pdiff{}{x_1} + \rmi\qm_1, \pdiff{}{x_2} + \rmi\qm_2, \rmi\wavenumber}^\top
...
\begin{subequations} \label{eq:QGFullSystem}
	...
	\end{align}
\end{subequations}
\tstk{again, spurious $-$ sign above might change parts of these equations!!!}
