...
\title{Paper Curl 2021}  % Declares the document's title.
...
\tstk{for the most part, this is a copy of the QG section of the Scalar Paper (up to notational changes) --- any major changes to the scalar case should be reviewed in this text too}
\input{./Sections/QuantumGraphs}

\input{./Sections/SystemDerivation}
%
...
\input{./Sections/Appendix/A-SingularMeasures}

\input{./Sections/Appendix/A-MeasureTheory}

\input{./Sections/Appendix/A-MuAnalysis}

\input{./Sections/Appendix/A-NuAnalysis}

\input{./Sections/Appendix/A-SumMeasureAnalysis}
