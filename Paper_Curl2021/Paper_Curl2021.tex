...
\tstk{THIS NEXT SECTION IS SLICED FROM THE SCALAR PAPER - CREATE A NEW FILE FOR CURL-CURL PAPER ONCE SCALAR PAPER IS DONE.}
\input{../Paper_Scalar2020/Sections/QuantumGraphs}
