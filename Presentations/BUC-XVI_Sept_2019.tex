...
\begin{frame}
	...
	\begin{align*}
		...
		\mathrm{dom}\mathcal{A} &= \{u\in H^2\bracs{I_{jk}} \ \vert \ u \text{ is continuous at every } v_j\in V, \\ & \text{+ derivative matching conditions on } u\}
	\end{align*}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\only<5->{
			\item Analysis: singular-structures as some limit of thin-structures
		}
		\only<6>{
			\begin{itemize}
