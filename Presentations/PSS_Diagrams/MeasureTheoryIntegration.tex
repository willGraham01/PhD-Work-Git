...
\begin{tikzpicture}
	...
	\begin{scope}[scale=0.8]
		\draw[->] (-0.3,0) -- (10,0) node[anchor=west] {$\nu$};
		...
		\node[align=center, red] at (4,0.5) {$I_1$};
		\draw[->, red] (4-0.5,1.5) -- (0,1.5); 
		\draw[->, red] (4+0.5,1.5) -- (8,1.5);
		\node[align=center, red] at (4,1.5) {$I_2$};
		...
		\node[align=center, red] at (4,4.5) {$I_{N-1}$};
		\draw[->, red] (4-0.5,5.45) -- (3.36754,5.45); 
		\draw[->, red] (4+0.5,5.45) -- (4.63246,5.45);
		\node[align=center, red] at (4,5.45) {$I_{N}$};
	\end{scope}
