...
%changes the title of the bibliograph page to ``References"
...
\input{./WorkInChapters/Introduction}

\input{./WorkInChapters/QuantumGraphs}

\input{./WorkInChapters/ScalarEqns}

\input{./WorkInChapters/VectorEqns}

\input{./WorkInChapters/ExampleSystems}

\input{./WorkInChapters/Conclusion}

\newpage %have a new page to start the bibliography
\bibliographystyle{acm}
\bibliography{ConfRepBib.bib}
