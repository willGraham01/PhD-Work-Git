...
\tstk{we suggested to put this onto one line, but then the proof becomes cumbersome and undoes most of the space that we saved from compacting the statement. Plus, we don't go onto a new page in the current format, so I'm leaving it like this for now}
