...
\tstk{some of this should go into physical motivation, some of it should stay here.
There might even be a case for another section, ``problem contextifying" or something, just to be clear on how everything is coming together}
We briefly elaborate on this with the motivation below --- the concepts and statements can be made mathematically precise, and the interested reader can find these details in \tstk{exner-post, kuchment-zheng}.
