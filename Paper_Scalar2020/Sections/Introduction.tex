...
After some futher analysis of the operator $\tgrad_{\mu}$ (see appendix \tstk{ref}), \eqref{eq:PeriodCellLaplaceStrongForm} can be shown to reduce to a family of quantum graph problems; \tstk{include vertex constants $\alpha$ in here, as this is the general form of these equations!}
