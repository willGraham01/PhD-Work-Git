...
\tstk{this does mean that you're gunna have to go through and replace all the $\omega^2$s with $z$s Will, although it might be more convenient to use $z^2$ above, just to save on inserting square-roots everywhere.}
