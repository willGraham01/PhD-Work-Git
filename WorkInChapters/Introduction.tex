...
\tstk{section on variational problems on singular structures (IE Zhikov lit review)????}
...
\section{Thin and Singular Structure Problems} \label{sec:GraphLitReview}
...
In particular, we are required to adopt a variational framework for our model that respects the lower-dimensional singular-structure we obtain. \tstk{Zhikov review section}
