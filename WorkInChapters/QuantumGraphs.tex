...
Rather we will begin with a periodic embedded graph, and then using a Gelfand transform we will obtain an equivalent problem on the period graph, which gives rise to a quantum graph to which we can apply the following theory.
