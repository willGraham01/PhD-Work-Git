...
\tstk{now the stuff about the inherent structure of the Sobolev space, probably going to need it's own subsection!}
...
This analysis allows us to reduce the problem
