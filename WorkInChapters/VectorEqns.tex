...
\begin{subequations} \label{eq:CurlVertexConditions}
	\begin{align}
		...
		0 &= \sum_{j\sim k} \bracs{\diff{}{t} + i\bracs{R_{jk}\qm}_2}u_{3,jk}\bracs{v_j} - i\wavenumber u_{2,jk}\bracs{v_j}, \label{eq:CurlVertexConditionsSumDeriv}\\
		0 &= \sum_{j\sim k}u_{2,jk}\bracs{v_j}, \ \forall v_j\in V. \label{eq:CurlVertexConditionsSum2}
	\end{align}
\end{subequations}
...
In chapter \ref{ch:ExampleSystems} we will tie together the work of this chapter and chapter \tstk{quantum graphs} and present some example wave-guidance problems, solved using the approaches described in those chapters.
