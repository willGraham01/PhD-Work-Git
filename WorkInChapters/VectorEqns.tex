...
Fortunately for us this does not mean our singular-structure domains as described in section \ref{sec:OurPhysicalSystem} give only trivial solutions.
...
For the purposes of this report, this is all that we require for our analysis and the examples that we will consider in chapter \ref{ch:ExampleSystems}, because it provides us with enough vertex or boundary conditions in the equivalent quantum graph problem.
