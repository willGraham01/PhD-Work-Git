...
\end{align*}
In particular the first two convergences imply that $\widetilde{\alpha}=\widetilde{u}'$; that is that $\widetilde{\alpha}$ is the distributional derivative of $\widetilde{u}\in\gradSob{\sqbracs{0,\abs{I_{ij}}}}{t}$.
