...
\begin{figure}[h]
	...
	\caption{\label{fig:ThickVertex_CurlsTFRSetup_k1a1} The expression \tstk{ref} for a fixed value of $\wavenumber$. Red regions indicate those $\omega$ that correspond to eigenvalues $\omega^2$, when the expression takes values between $-1$ and $1$ (black lines).}
\end{figure}
\begin{figure}[h]
	\centering
