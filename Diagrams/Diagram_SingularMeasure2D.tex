...
\begin{tikzpicture}[-,>=stealth',auto,node distance=4cm,thick,main node/.style={circle,draw,font=\sffamily\Large\bfseries}]
	...
	\begin{scope}
		\draw[black!95!white, line width=2] (0.55,-0.55) -- (1.75,-1.75);
		\node[black!95!white, anchor=north east] at (1.25,-1.25) {$\lambda_{14}(B)$};
		
		\draw[black!95!white, line width=2] (0.55, 0.55) -- (2.25,2.25);
		\node[black!95!white, anchor=north west] at (1.5,1.5) {$\lambda_{12}(B)$};
	\end{scope}
\end{tikzpicture}
